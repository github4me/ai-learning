...
Completed 200 parameter updates; CPU, seed=7.

Training-set evaluation loss: 3.396807 → 2.338896.

Validation loss: 3.402230 → 2.545137.

Maximum logit difference on the same input after save/load: 0. This checks inference reload, not exact training resumption.
